@extends('admin.main')
@section('content')
<div style="overflow:scroll; height:600px;" class="admin-content-main-content-product-list">
    <table>
        <thead>
            <tr>
                <th>ID</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/admin/product/edit/{{$product -> id}}" class="edit-class" href="/admin/product/edit/">Sửa</a> 
                    | 
